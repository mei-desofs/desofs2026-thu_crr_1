...
const cards: DashboardCard[] = [
  {
    title: "Invite User",
    description:
      "Send an invitation to a new Manager or Carrier to join the platform.",
    href: "/invite",
    available: true,
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "View, edit, and create products in your catalogue with full control.",
  ...
  },
  {
    title: "Stock",
    description:
      "View and manage current stock levels across all products and warehouses.",
    href: "/manager/stock",
    available: true,
    icon: (
      <svg
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-400">
            Manage your platform - invite users, maintain the catalogue, and
            keep your data safe.
          </p>
        </div>
          ...
          {cards.map((card) =>
            card.available ? (
              ...
              >
                ...
                <div>
                  <h2 className="text-slate-400 font-semibold mb-1">
                    {card.title}
                  </h2>
